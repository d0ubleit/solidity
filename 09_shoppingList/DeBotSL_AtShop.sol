    ...
    function openMenu() public override {
        ...
        Menu.select(
            ...
            [
                ...
                MenuItem("Shopping list manager","",tvm.functionId(callbackToManager))
            ] 
        ); 
    }


    function callbackToManager() public {
        IDeBotSL_Manager(invoker_addr).callbackFromAtShopDebot();
    }
